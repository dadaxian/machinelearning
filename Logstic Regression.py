...
def run_logistic(data, theta, batchSize, iter, alpha):
    ...
    if batchSize == n:
        print("Logistic Regression with", "Gradient:")
    elif batchSize == 1:
        print("Logistic Regression with", "Stochastic:")
    else:
        print("Logistic Regression with", "Mini-batch:")
...
if __name__ == '__main__':
    ...
    run_logistic(data, theta, 2, 100, alpha=0.001)   #SGD
